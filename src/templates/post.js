    ...
    render() {
        return (
            ...
            <section className="post">
                ...
                <img className="header-image" src={safePrefix(this.props.pageContext.frontmatter.content_img_path)} alt=""/>
                }
                <header className="hero">
                    <div className="copy">
                        <h1>{_.get(this.props, 'pageContext.frontmatter.title')}</h1>
                        {this.props.pageContext.frontmatter.subtitle && 
                        <h3>{htmlToReact(this.props.pageContext.frontmatter.subtitle)}</h3>
                        }
